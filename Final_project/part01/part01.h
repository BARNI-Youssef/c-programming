...
#define FILE_READ_ERROR 3
                    ...
                    /*The boring functions, all though they are usefull, nothing fun here*/
...
city* all_cites(char**);                       /*takes an array of strings and return an array of cities with all the relevant informations*/
                    ...
                    /*The whole program revole around this function, surely it will be impressive, right ?... RIGHT ??*/

int all_paths(city*, path_list, int); /*Takes an array of city, and try every single path possible that may lead to E, the road of life*/